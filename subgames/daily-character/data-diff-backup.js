...
const characters = [
    ...
    },
    {
      ...
      "explanation": "淖（nào）：1. 烂泥，泥沼。2. 蒙古语称湖泊为‘淖尔’。如百灵淖（内蒙古地名）。也读zhuō，姓。",
      "errorReasonType": 2,
      "difficultyLevel": "中级"
    },
    {
    ...
    },
    {
      ...
      "explanation": "阿（ē）：1. 迎合，偏袒：阿谀。2. 凹曲处：山阿。3. 用于人名、地名，如阿房宫（在陕西省西安市）。",
      "errorReasonType": 2,
      "difficultyLevel": "初级"
    },
    {
    ...
    },
    {
      ...
      "explanation": "鄄（juàn）：地名，在山东省菏泽市，如鄄城（在山东省菏泽市）。",
      "errorReasonType": 6,
      "difficultyLevel": "高级"
    },
    {
    ...
    },
    {
      ...
      "explanation": "柘（zhè）：1. 落叶灌木或小乔木。2. 姓。",
      "errorReasonType": 3,
      "difficultyLevel": "中级"
    },
    {
    ...
    },
    {
      ...
      "explanation": "囫（hú）：用于‘囫囵’，完整，整个的：囫囵吞枣（比喻读书等不加分析地笼统接受）。",
      "errorReasonType": 3,
      "difficultyLevel": "中级"
    },
    {
      ...
      "explanation": "囵（lún）：用于‘囫囵’，完整，整个的：囫囵吞枣（比喻读书等不加分析地笼统接受）。",
      "errorReasonType": 3,
      "difficultyLevel": "中级"
    },
    {
